...
from nflows.transforms.autoregressive import MaskedAffineAutoregressiveTransform, MaskedPiecewiseQuadraticAutoregressiveTransform, MaskedPiecewiseRationalQuadraticAutoregressiveTransform, IndependentRQS, AutoregressiveRQS
from nflows.transforms.permutations import ReversePermutation, RandomPermutation
from nflows.transforms.customFlows import Conditional1DRQS, ConditionalMultiRQS
...
class chainedNFTrainer:
    def __init__(self,projName,bkg_train,bkg_test,data_train,data_test,varNames,control=[],NF_kwargs={},outDir="NF_models_QR_general/",rangeScale=3,separateScale=False,minmax=True,useScale=True):
